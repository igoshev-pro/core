...
type ApiKind = "pages";
type ExtendedProps = PageUpsertSectionMainProps & { api?: ApiKind };

export default function PageUpsertSectionMainC({
    type,
    projectId,
    id,
    api = "pages",
        ...
        if (type === UpsertType.Create) {
            ...
            try {
                ...
                addToast({
                    color: "success",
                    title: "Успешно!",
                    description: `Страница создана успешно`,
                    variant: "solid",
                    radius: "lg",
                    timeout: 3000,
                    shouldShowTimeoutProgress: true,
                });
                router.push(`/admin/factory/pages`);
            } catch {
                addToast({
                    color: "danger",
                    title: "Ошибка!",
                    description: `Произошла ошибка при создании страницы`,
                    variant: "solid",
                    radius: "lg",
                    timeout: 3000,
                    shouldShowTimeoutProgress: true,
